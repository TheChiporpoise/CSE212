...
public class TakingTurnsTests
{
    ...
    {
        System.Console.WriteLine("Running TestTakingTurns1");
        ...
        // Defect(s) Found: PersonQueue.Enqueue was using Insert instead of Add to add to the front of the list.
    }

    [Test]
    public void TestTakingTurns2()
    {
        System.Console.WriteLine("Running TestTakingTurns2");
        // Test 2
    ...
    {
        System.Console.WriteLine("Running TestTakingTurns3");
        // Test 3
        ...
        // Defect(s) Found: GetNextPerson didn't have infinite turns implemented, so I added the contion that to be readded their turns needed to be less than or equal to 0
    }

    [Test]
    public void TestTakingTurns4()
    {
        System.Console.WriteLine("Running TestTakingTurns4");
        // Test 4
