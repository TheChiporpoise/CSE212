...
public class Maze {
    ...
    public bool MoveLeft() {
        // FILL IN CODE
        if (_mazeMap[(_currX, _currY)][0]) { // check the left direction for current position
            _currX -= 1;
            return true;
        }
    ...
    public bool MoveRight() {
        // FILL IN CODE
        if (_mazeMap[(_currX, _currY)][1]) { // check the right direction for current position
            _currX += 1;
            return true;
        }
    ...
    public bool MoveUp() {
        // FILL IN CODE
        if (_mazeMap[(_currX, _currY)][2]) { // check the left direction for current position
            _currY -= 1;
            return true;
        }
    ...
    public bool MoveDown() {
        // FILL IN CODE
        if (_mazeMap[(_currX, _currY)][3]) { // check the left direction for current position
            _currY += 1;
            return true;
        }
